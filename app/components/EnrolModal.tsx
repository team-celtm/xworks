          ...
          <div>
            <div className="enrol-success">
              ...
              <div className="enrol-confirm-card">
                ...
                {enrolData.date && <div className="enrol-confirm-row"><span className="enrol-confirm-label">Date & time</span><span className="enrol-confirm-val">{enrolData.date} · {enrolData.time}</span></div>}
